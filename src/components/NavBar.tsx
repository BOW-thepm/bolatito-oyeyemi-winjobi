        ...
        <div className="hidden md:flex space-x-8">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className="text-gray-700 hover:text-designer-purple font-medium transition-colors"
            >
              {link.name}
            </a>
          ))}
          ...
          <div className="container mx-auto py-4 flex flex-col space-y-4">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-gray-700 hover:text-designer-purple font-medium px-4 py-2 rounded-md transition-colors"
