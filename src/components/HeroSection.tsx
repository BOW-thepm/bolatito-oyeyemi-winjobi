            ...
            <div className="relative">
              ...
              >
                <CarouselContent>
                  <CarouselItem>
                    <motion.div 
                      className="relative z-10 rounded-xl bg-white dark:bg-gray-800 shadow-2xl overflow-hidden"
                      whileHover={{ scale: 1.02, rotate: 0 }}
                      initial={{ rotate: 3 }}
                      transition={{ duration: 0.5 }}
                    >
                      <img 
                        src="/lovable-uploads/54b37118-d82f-4885-a3ae-48c116c69da7.png" 
                  ...
                  <CarouselItem>
                    ...
                    >
                      <img 
                        src="/lovable-uploads/3a8a97c9-56ff-437b-a188-6a058798ea0f.png" 
                        alt="Designer portrait alternative pose" 
                        className="w-full h-[500px] object-cover" 
                      />
                    </motion.div>
                  </CarouselItem>
